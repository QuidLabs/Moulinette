...
export const Mint = () => {
  ...
  const handleSubmit = async e => {
    ...
    const balance = async () => {
      if (sdai) Number(formatUnits(await sdai.method.balanceOf(account).call(), 18))
    }
      ...
      <div>
        <div>
          ...
          <div className="mint-inputContainer">
            ...
            <button
              className="mint-maxButton"
              onClick={handleSetMaxValue}
              type="button">
              Max
              <Icon
                preserveAspectRatio="none"
                className="mint-maxButtonBackground"
                name="btn-bg"
              />
            </button>
          </div>
          ...
          <button
            ...
            <Icon
              preserveAspectRatio="none"
              className="mint-submitBtnL1"
              name="composite-btn-l1"
            />
            <Icon
              preserveAspectRatio="none"
              className="mint-submitBtnL2"
              name="composite-btn-l2"
            />
            <Icon
              preserveAspectRatio="none"
              className="mint-submitBtnL3"
