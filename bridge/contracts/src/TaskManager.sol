...
import "../lib/eigenlayer-middleware/src/interfaces/IBLSSignatureChecker.sol";

contract TaskManager is Initializable, OwnableUpgradeable, 
    Pausable, BLSSignatureChecker, OperatorStateRetriever,
    ITaskManager { using BN254 for BN254.G1Point;
    ...
    function raiseAndResolveChallenge(
        ...
        string calldata btcTxHash = task.btcTxHash;
        // some logical checks
        require(
